            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse navbar-right">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="active"><a href="contact_ro.php">Contact</a></li>
						<li class="dropdown">
							...
							<ul class="dropdown-menu" role="menu">
								<li><a href="contact.php" class="language"> <img src="images/language/magyar.gif" alt="..." class="img-thumbnail icon-small">  <span>Maghiară</span></a></li>
								...
								<li><a href="contact_ger.php" class="language"><img src="images/language/german.gif" alt="..." class="img-thumbnail icon-small">  <span>Germană</span></a></li
							</ul>
						</li>
                    </ul>
                </div>
            ...
            <div class="row contact-wrap">
                ...
                <form method="post">
                    ...
                    <div class="col-sm-5">
                        ...
                        <div class="form-group">
                            <button type="submit" name="submit" class="btn btn-primary btn-lg" required="required">Trimitere</button>
                        </div>
                    </div>
